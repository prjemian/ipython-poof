...
## The name of a Pygments style to use for syntax highlighting:  autumn, monokai,
#  vs, algol_nu, murphy, lovelace, perldoc, igor, algol, emacs, trac, pastie,
#  colorful, friendly, vim, borland, bw, fruity, xcode, rrt, manni, default,
#  paraiso-dark, paraiso-light, native, tango
